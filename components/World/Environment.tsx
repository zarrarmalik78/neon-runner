...
const StarField: React.FC = () => {
  ...
  return (
    /* Fix: points, bufferGeometry, bufferAttribute are Three.js intrinsic elements */
    <points ref={meshRef}>
      <bufferGeometry>
        <bufferAttribute
...
const LaneGuides: React.FC = () => {
    ...
    return (
        /* Fix: group, mesh, planeGeometry, meshBasicMaterial are Three.js intrinsic elements */
...
const RetroSun: React.FC = () => {
    ...
    return (
        /* Fix: group, mesh, sphereGeometry, shaderMaterial are Three.js intrinsic elements */
...
export const Environment: React.FC = () => {
  return (
    <>
      {/* Fix: color, fog, ambientLight, directionalLight, pointLight are Three.js intrinsic elements */}
